...
(function (la, s, p) {
    (function (i) {
        if (typeof define === "function" && define.amd)
            ...
            jQuery && !jQuery.fn.dataTable && i(jQuery)
    })(function (i) {
        var l = function (h) {
            function n(a, b) {
                var c = l.defaults.columns, d = a.aoColumns.length;
                b = i.extend({}, l.models.oColumn, c, {sSortingClass: a.oClasses.sSortable, sSortingClassJUI: a.oClasses.sSortJUI, nTh: b ? b : s.createElement("th"), sTitle: c.sTitle ? c.sTitle : b ? b.innerHTML : "", aDataSort: c.aDataSort ? c.aDataSort : [d], mData: c.mData ? c.oDefaults : d});
                a.aoColumns.push(b);
                if (a.aoPreSearchCols[d] ===
                        p || a.aoPreSearchCols[d] === null)
                    a.aoPreSearchCols[d] = i.extend({}, l.models.oSearch);
                else {
                    ...
                    if (b.bSmart === p)
                        b.bSmart = true;
                    if (b.bCaseInsensitive === p)
                        b.bCaseInsensitive = true
                }
                q(a, d, null)
            }
            function q(a, b, c) {
                ...
                if (b)
                    for (e = b.length - 1; e >= 0; e--) {
                        ...
                        for (g = m.length; f < g; f++)
                            if (typeof m[f] === "number" && m[f] >= 0) {
                                for (; a.aoColumns.length <= m[f]; )
                                    n(a);
                                d(m[f], b[e])
                            } else if (typeof m[f] === "number" && m[f] < 0)
                                d(a.aoColumns.length + m[f], b[e]);
                            else if (typeof m[f] ===
                                    "string") {
                                j = 0;
                                for (k = a.aoColumns.length; j < k; j++)
                                    if (m[f] == "_all" || i(a.aoColumns[j].nTh).hasClass(m[f]))
                                        d(j, b[e])
                            }
                    }
                if (c) {
                ...
                for (var f = a.aoColumns.length; d < f; d++) {
                    ...
                    if (c._bAutoType && c.sType != "string") {
                        ...
                        if (e !== null && e !== "") {
                            ...
                            if (c.sType === null)
                                c.sType = e;
                            else if (c.sType != e && c.sType != "html")
                                c.sType = "string"
                        }
                    }
                }
            ...
            function ea(a) {
                ...
                for (e = a.aoColumns.length; c < e; c++) {
                    j = a.aoColumns[c];
                    if (j.sTitle === null)
                        j.sTitle = j.nTh.innerHTML;
                    var k = j._bAutoType, m = typeof j.fnRender === "function", u = j.sClass !== null, x = j.bVisible, y, B;
                    if (k || m || u || !x) {
                        g = 0;
                        for (b = a.aoData.length; g < b; g++) {
                            ...
                            if (k && j.sType !=
                                ...
                                if (B !== "") {
                                    ...
                                    if (j.sType === null)
                                        j.sType = B;
                                    else if (j.sType != B && j.sType != "html")
                                        j.sType = "string"
                                }
                            }
                            if (j.mRender)
                                y.innerHTML = F(a, g, c, "display");
                            else if (j.mData !== c)
                                y.innerHTML = F(a, g, c, "display");
                            if (m) {
                                B = da(a, g, c);
            ...
            function F(a, b, c, d) {
                ...
                if (c === null && e.sDefaultContent !== null)
                    c = e.sDefaultContent;
            ...
            function da(a, b, c) {
                var d = a.aoColumns[c];
                return d.fnRender({iDataRow: b, iDataColumn: c, oSettings: a,
                    aData: a.aoData[b]._aData, mDataProp: d.mData}, F(a, b, c, "display"))
            }
            function ua(a, b) {
                var c = a.aoData[b], d;
                if (c.nTr === null) {
                    ...
                    if (c._aData.DT_RowId)
                        c.nTr.id = c._aData.DT_RowId;
                    if (c._aData.DT_RowClass)
            ...
            function Ka(a) {
                ...
                if (a.oFeatures.bSort)
                    for (b = 0; b < a.aoColumns.length; b++)
                        a.aoColumns[b].bSortable !== false ? ya(a, a.aoColumns[b].nTh, b) : i(a.aoColumns[b].nTh).addClass(a.oClasses.sSortableNone);
            ...
            function H(a) {
                ...
                if (i.inArray(false, b) !== -1)
                    ...
                    if (a.aiDisplay.length !== 0) {
                        ...
                        if (a.asStripeClasses[0])
                            b[0].className = a.asStripeClasses[0];
                        c = a.oLanguage;
                        f = c.sZeroRecords;
                        if (a.iDraw == 1 && a.sAjaxSource !== null && !a.oFeatures.bServerSide)
                            f = c.sLoadingRecords;
                        else if (c.sEmptyTable && a.fnRecordsTotal() ===
                                0)
                            f = c.sEmptyTable;
                ...
                for (var c = a.nTableWrapper, d = a.sDom.split(""), e, f, g, j, k, m, u, x = 0; x < d.length; x++) {
                    ...
                    if (g == "<") {
                        ...
                        if (k == "'" || k == '"') {
                            ...
                            if (m == "H")
                                m = a.oClasses.sJUIHeader;
                            else if (m == "F")
                                m = a.oClasses.sJUIFooter;
                            if (m.indexOf(".") != -1) {
                                k =
                                        m.split(".");
                    ...
                    if (f == 1 && e !== null) {
                        if (typeof a.aanFeatures[g] !== "object")
                            a.aanFeatures[g] = [];
            ...
            function Ua(a, b) {
                ...
                for (var e = 0, f = b.length; e < f; e++)
                    if (c) {
                        for (var g = [], j = 0, k = a.aoColumns.length; j < k; j++)
                            g.push(b[e][d[j]]);
                        R(a, g)
                    } else
                        R(a, b[e]);
            ...
            function Oa(a) {
                ...
                if (!a.aanFeatures.f)
                    d.id = a.sTableId + "_filter";
                c = i('input[type="text"]', d);
                d._DT_Input = c[0];
                c.val(b.sSearch.replace('"', "&quot;"));
                c.bind("keyup.DT", function () {
                    for (var e = a.aanFeatures.f, f = this.value === "" ? "" : this.value, g = 0, j = e.length; g < j; g++)
                        e[g] != i(this).parents("div.dataTables_filter")[0] && i(e[g]._DT_Input).val(f);
                    f != b.sSearch && X(a, {sSearch: f, bRegex: b.bRegex, bSmart: b.bSmart, bCaseInsensitive: b.bCaseInsensitive})
                });
            ...
            function Xa(a) {
                for (var b = l.ext.afnFiltering, c = A(a, "bSearchable"), d = 0, e = b.length; d < e; d++)
                    for (var f = 0, g = 0, j = a.aiDisplay.length; g < j; g++) {
            ...
            function Va(a, b, c, d, e, f) {
                ...
                e = a.oPreviousSearch;
                c || (c = 0);
                if (l.ext.afnFiltering.length !== 0)
                    c = 1;
                if (b.length <= 0) {
                    a.aiDisplay.splice(0, a.aiDisplay.length);
                    a.aiDisplay = a.aiDisplayMaster.slice()
            ...
            function Ba(a, b) {
                if (!a.oFeatures.bServerSide) {
                    ...
                    for (var d = 0, e = b.length; d < e; d++)
                        a.asDataSearch[d] = Da(a, na(a, b[d], "filter", c))
                }
            }
            function Da(a, b) {
                a = b.join("  ");
            ...
            function Ya(a, b) {
                if (typeof l.ext.ofnSearch[b] === "function")
                    return l.ext.ofnSearch[b](a);
                else if (a === null)
                    return"";
                else if (b == "html")
                    return a.replace(/[\r\n]/g, " ").replace(/<.*?>/g, "");
            ...
            function Za(a) {
                if (!(!a.oFeatures.bInfo || a.aanFeatures.i.length === 0)) {
                    var b = a.oLanguage, c = a._iDisplayStart + 1, d = a.fnDisplayEnd(), e = a.fnRecordsTotal(), f = a.fnRecordsDisplay(), g;
                    ...
                    g = za(a,
                            g);
                    if (b.fnInfoCallback !== null)
                        g = b.fnInfoCallback.call(a.oInstance, a, c, d, e, f, g);
                    a = a.aanFeatures.i;
                    b = 0;
                ...
                if (a.bInitialised === false)
                    ...
                    for (c = a.aoColumns.length; b < c; b++)
                        if (a.aoColumns[b].sWidth !== null)
                            a.aoColumns[b].nTh.style.width = t(a.aoColumns[b].sWidth);
                    if (a.oFeatures.bSort)
                        $(a);
                    else if (a.oFeatures.bFilter)
                        X(a, a.oPreviousSearch);
            ...
            function Na(a) {
                ...
                if (e.length == 2 && typeof e[0] === "object" && typeof e[1] === "object") {
                    c = 0;
                    for (d = e[0].length; c < d; c++)
                        b += '<option value="' + e[0][c] + '">' + e[1][c] + "</option>"
                } else {
                    c = 0;
                    for (d = e.length; c < d; c++)
                        b += '<option value="' + e[c] + '">' + e[c] + "</option>"
                }
                b += "</select>";
                e = s.createElement("div");
                if (!a.aanFeatures.l)
                    e.id = a.sTableId + "_length";
                ...
                i("select", e).bind("change.DT", function () {
                    ...
                    for (d = g.length; c < d; c++)
                        g[c] != this.parentNode && i("select", g[c]).val(f);
            ...
            function Sa(a) {
                ...
                a.aanFeatures.p || a.aoDrawCallback.push({fn: function (c) {
            ...
            function Ga(a, b) {
                ...
                if (typeof b === "number") {
                    ...
                    if (a._iDisplayStart > a.fnRecordsDisplay())
                        a._iDisplayStart = 0
                } else if (b == "first")
                    a._iDisplayStart = 0;
                else if (b == "previous") {
            ...
            function P(a, b) {
                if (a.oFeatures.bProcessing)
                    for (var c = a.aanFeatures.r, d = 0, e = c.length; d < e; d++)
            ...
            function Qa(a) {
                ...
                var b = s.createElement("div"), c = s.createElement("div"),
                        d = s.createElement("div"), e = s.createElement("div"), f = s.createElement("div"), g = s.createElement("div"), j = a.nTable.cloneNode(false), k = a.nTable.cloneNode(false), m = a.nTable.getElementsByTagName("thead")[0], u = a.nTable.getElementsByTagName("tfoot").length === 0 ? null : a.nTable.getElementsByTagName("tfoot")[0], x = a.oClasses;
                c.appendChild(d);
                f.appendChild(g);
                ...
                if (d.length > 0) {
                    d = d[0];
                    if (d._captionSide === "top")
                        j.appendChild(d);
                    else
                        d._captionSide === "bottom" && u && k.appendChild(d)
                }
                if (a.oScroll.sX !== "") {
                    c.style.width = t(a.oScroll.sX);
                    e.style.width = t(a.oScroll.sX);
                    if (u !== null)
                        f.style.width = t(a.oScroll.sX);
                    i(e).scroll(function () {
                ...
                if (a.oScroll.sY !== "")
                    e.style.height = t(a.oScroll.sY);
                a.aoDrawCallback.push({fn: $a, sName: "scrolling"});
                a.oScroll.bInfinite &&
                        i(e).scroll(function () {
                    if (!a.bDrawing && i(this).scrollTop() !== 0)
            ...
            function $a(a) {
                var b = a.nScrollHead.getElementsByTagName("div")[0], c = b.getElementsByTagName("table")[0], d = a.nTable.parentNode, e, f, g, j, k, m, u, x, y = [], B = [], T = a.nTFoot !== null ? a.nScrollFoot.getElementsByTagName("div")[0] : null, M = a.nTFoot !== null ? T.getElementsByTagName("table")[0] :
                ...
                if (a.oScroll.bCollapse && a.oScroll.sY !== "")
                    d.style.height = d.offsetHeight + a.nTHead.offsetHeight + "px";
                e = i(a.nTable).outerWidth();
                if (a.oScroll.sX === "") {
                    a.nTable.style.width = "100%";
                    if (L && (i("tbody", d).height() > d.offsetHeight || i(d).css("overflow-y") == "scroll"))
                        a.nTable.style.width = t(i(a.nTable).outerWidth() -
                                a.oScroll.iBarWidth)
                } else if (a.oScroll.sXInner !== "")
                    a.nTable.style.width = t(a.oScroll.sXInner);
                else if (e == i(d).width() && i(d).height() < i(a.nTable).height()) {
                    a.nTable.style.width = t(e - a.oScroll.iBarWidth);
                    if (i(a.nTable).outerWidth() > e - a.oScroll.iBarWidth)
                        a.nTable.style.width = t(e)
                } else
                    a.nTable.style.width = t(e);
                e = i(a.nTable).outerWidth();
                N(ja, j);
                ...
                if (i(a.nTable).outerWidth() < e) {
                    ...
                    if (L && (d.scrollHeight > d.offsetHeight || i(d).css("overflow-y") == "scroll"))
                        a.nTable.style.width = t(g - a.oScroll.iBarWidth);
                    d.style.width = t(g);
                    a.nScrollHead.style.width = t(g);
                    if (a.nTFoot !== null)
                        a.nScrollFoot.style.width =
                                t(g);
                    if (a.oScroll.sX === "")
                        O(a, 1, "The table cannot fit into the current element which will cause column misalignment. The table has been drawn at its minimum possible width.");
                    else
                        a.oScroll.sXInner !== "" && O(a, 1, "The table cannot fit into the current element which will cause column misalignment. Increase the sScrollXInner value or remove it to allow automatic calculation")
                } else {
                    d.style.width = t("100%");
                    a.nScrollHead.style.width = t("100%");
                    if (a.nTFoot !== null)
                        a.nScrollFoot.style.width = t("100%")
                }
                if (a.oScroll.sY ===
                        "")
                    if (L)
                        d.style.height = t(a.nTable.offsetHeight + a.oScroll.iBarWidth);
                if (a.oScroll.sY !== "" && a.oScroll.bCollapse) {
                    ...
                    if (a.nTable.offsetHeight < d.offsetHeight)
                        d.style.height = t(a.nTable.offsetHeight + L)
                }
            ...
            function ta(a) {
                var b = 0, c, d = 0, e = a.aoColumns.length, f, g, j = i("th", a.nTHead), k = a.nTable.getAttribute("width");
                g = a.nTable.parentNode;
                for (f = 0; f < e; f++)
                    if (a.aoColumns[f].bVisible) {
                        d++;
                        if (a.aoColumns[f].sWidth !== null) {
                            c = ab(a.aoColumns[f].sWidthOrig, g);
                            if (c !== null)
                                a.aoColumns[f].sWidth = t(c);
                            b++
                        }
                    }
                if (e == j.length && b === 0 && d == e && a.oScroll.sX === "" && a.oScroll.sY === "")
                    ...
                    for (f = d = 0; f < e; f++) {
                        var m = a.aoColumns[f];
                        if (m.bVisible && m.sWidthOrig !== null && m.sWidthOrig !== "")
                            j[f - d].style.width = t(m.sWidthOrig);
                        else if (m.bVisible)
                            j[f - d].style.width = "";
                        else
                            d++
                    ...
                    for (f =
                        ...
                        if (a.aoColumns[f].bVisible) {
                            ...
                            if (d !== null) {
                                d = d.cloneNode(true);
                                if (a.aoColumns[f].sContentPadding !== "")
                    ...
                    if (a.oScroll.sX !== "" && a.oScroll.sXInner !== "")
                        b.style.width = t(a.oScroll.sXInner);
                    else if (a.oScroll.sX !== "") {
                        b.style.width = "";
                        if (i(b).width() < g.offsetWidth)
                            b.style.width = t(g.offsetWidth)
                    ...
                    if (e.length === 0)
                        e = Z(a, i("thead", b)[0]);
                    if (a.oScroll.sX !== "") {
                        for (f = d = g = 0; f < a.aoColumns.length; f++)
                            if (a.aoColumns[f].bVisible) {
            ...
            function cb(a, b) {
                if (a.oScroll.sX === "" && a.oScroll.sY !== "") {
                    ...
                    b.style.width = t(i(b).outerWidth())
            }
            function bb(a, b) {
                var c = db(a, b);
                if (c < 0)
            ...
            function $(a, b) {
                var c, d, e, f, g, j, k = [], m = [], u = l.ext.oSort, x = a.aoData, y = a.aoColumns, B = a.oLanguage.oAria;
                    ...
                    for (c = 0; c < k.length; c++) {
                        ...
                        if (l.ext.afnSortData[f]) {
                            ...
                            if (g.length === x.length) {
                                ...
                                O(a, 0, "Returned data sort array (col " + d + ") is the wrong length")
                        }
                    }
                    c = 0;
                ...
                if ((b === p || b) && !a.oFeatures.bDeferRender)
                    ba(a);
                c = 0;
                for (d = a.aoColumns.length; c < d; c++) {
                    ...
                    if (y[c].bSortable)
                        if (k.length > 0 && k[0][0] == c) {
                            ...
                            b.setAttribute("aria-label", e + (y[c].asSorting[0] == "asc" ? B.sSortAscending : B.sSortDescending));
                    else
            ...
            function ba(a) {
                ...
                if (a.oFeatures.bSort && a.oFeatures.bSortClasses) {
                    ...
                    for (c = a.length; b < c; b++) {
                        ...
                        j = d.replace(f, k);
                        if (j != d)
                            a[b].className = i.trim(j);
                        else if (k.length > 0 && d.indexOf(k) == -1)
                            a[b].className = d + " " + k
                    }
                }
            }
            function Ha(a) {
                if (!(!a.oFeatures.bStateSave || a.bDestroying)) {
                    ...
                    var d = {iCreate: (new Date).getTime(), iStart: b ? 0 : a._iDisplayStart, iEnd: b ? a._iDisplayLength : a._iDisplayEnd, iLength: a._iDisplayLength, aaSorting: i.extend(true, [], a.aaSorting), oSearch: i.extend(true, {}, a.oPreviousSearch), aoSearchCols: i.extend(true, [], a.aoPreSearchCols), abVisCols: []};
                    b = 0;
                    for (c = a.aoColumns.length; b < c; b++)
                ...
                if (e + s.cookie.length + 10 > 4096) {
                    for (var j = 0, k = a.length; j < k; j++)
                        if (a[j].indexOf(d) != -1) {
                            var m = a[j].split("=");
                            try {
                                (g = eval("(" + decodeURIComponent(m[1]) + ")")) && g.iCreate && f.push({name: m[0], time: g.iCreate})
                            } catch (u) {
                            }
                        }
            ...
            function W(a, b) {
                ...
                for (e = e; e < k; e++) {
                    ...
                    if (j.nTr !== null) {
                        ...
                        f = d = 0;
                        for (g = a.aoColumns.length; f < g; f++)
                            if (a.aoColumns[f].bVisible)
                                c.push(b[f - d]);
                            else {
            ...
            function O(a, b, c) {
                a = a === null ? "DataTables warning: " + c : "DataTables warning (table id = '" +
                        a.sTableId + "'): " + c;
                if (b === 0)
                    if (l.ext.sErrMode == "alert")
                        alert(a);
                    else
                        throw new Error(a);
                else
                    la.console && console.log && console.log(a)
            }
            function r(a, b, c, d) {
                if (d === p)
                    d = c;
            ...
            function hb(a, b) {
                ...
                for (var d in b)
                    if (b.hasOwnProperty(d)) {
                        c = b[d];
                        if (typeof h[d] === "object" && c !== null && i.isArray(c) === false)
                            i.extend(true, a[d], c);
                        else
                            a[d] = c
                    }
            ...
            this.$ = function (a, b) {
                ...
                if (b.page == "current") {
                    b = c._iDisplayStart;
                    for (c = c.fnDisplayEnd(); b < c; b++)
                        (e = f[g[b]].nTr) && d.push(e)
                } else if (b.order == "current" && b.filter == "none") {
                    b = 0;
                    for (c = j.length; b < c; b++)
                        (e = f[j[b]].nTr) && d.push(e)
                    ...
                    O(c, 1, "Unknown selection options");
                f = i(d);
                d = f.filter(a);
                a = f.find(a);
            ...
            this.fnClose = function (a) {
                for (var b = C(this[l.ext.iApiIndex]), c = 0; c < b.aoOpenRows.length; c++)
            ...
            this.fnDeleteRow = function (a, b, c) {
                ...
                for (f = d.aoData.length; e < f; e++)
                    if (d.aoData[e].nTr !== null)
                        d.aoData[e].nTr._DT_RowIndex =
                                e;
            ...
            this.fnDestroy = function (a) {
                ...
                if (!a) {
                    ...
                    for (f = b.aoColumns.length; e <
                            f; e++)
                        b.aoColumns[e].bVisible === false && this.fnSetColumnVis(e, true)
                }
                ...
                if (!a && b.nTableReinsertBefore)
                    c.insertBefore(b.nTable, b.nTableReinsertBefore);
                else
                    a || c.appendChild(b.nTable);
                e = 0;
                for (f = b.aoData.length; e < f; e++)
                    b.aoData[e].nTr !== null && d.appendChild(b.aoData[e].nTr);
                if (b.oFeatures.bAutoWidth === true)
                    b.nTable.style.width = t(b.sDestroyWidth);
                if (f = b.asDestroyStripes.length) {
                    a = i(d).children("tr");
                    for (e = 0; e < f; e++)
                        a.filter(":nth-child(" + f + "n + " + e + ")").addClass(b.asDestroyStripes[e])
                }
                e = 0;
                for (f = l.settings.length; e < f; e++)
                    l.settings[e] == b && l.settings.splice(e, 1);
                h = b = null
            };
            ...
            this.fnFilter = function (a, b, c, d, e, f) {
                ...
                if (g.oFeatures.bFilter) {
                    ...
                    if (b === p || b === null) {
                        ...
                        i.extend(g.aoPreSearchCols[b], {sSearch: a + "", bRegex: c, bSmart: d,
                            bCaseInsensitive: f});
            ...
            this.fnGetNodes = function (a) {
                var b = C(this[l.ext.iApiIndex]);
                if (a !== p)
                    return b.aoData[a] !== p ? b.aoData[a].nTr : null;
                return fa(b)
            };
                ...
                if (g[a].bVisible != b) {
                    if (b) {
                        ...
                        for (f = j.length; e < f; e++)
                            if (j[e].nTr !== null)
                                m ? j[e].nTr.appendChild(j[e]._anHidden[a]) : j[e].nTr.insertBefore(j[e]._anHidden[a], W(d, e)[k])
                    } else {
                        e = 0;
                        for (f = j.length; e < f; e++)
                            if (j[e].nTr !== null) {
                    ...
                    for (f = d.aoOpenRows.length; e < f; e++)
                        d.aoOpenRows[e].nTr.colSpan = D(d);
                    if (c === p || c) {
                        o(d);
                        H(d)
                    }
            ...
            this.fnUpdate = function (a, b, c, d, e) {
                ...
                if (i.isArray(a) && c === p) {
                    ...
                    for (c = 0; c < f.aoColumns.length; c++)
                        this.fnUpdate(F(f, b, c), b, c, false, false)
            ...
            this.oApi = {_fnExternApiFunc: jb, _fnInitialise: ra, _fnInitComplete: pa, _fnLanguageCompat: Fa, _fnAddColumn: n, _fnColumnOptions: q, _fnAddData: R, _fnCreateTr: ua, _fnGatherData: ea, _fnBuildHead: Ka,
            ...
            this.each(function () {
                ...
                if (this.nodeName.toLowerCase() != "table")
                    O(null, 0, "Attempted to initialise DataTables on a node which is not a table: " + this.nodeName);
                else {
                    a = 0;
                    for (b = l.settings.length; a < b; a++) {
                        if (l.settings[a].nTable == this)
                            if (h === p || h.bRetrieve)
                                return l.settings[a].oInstance;
                            else if (h.bDestroy) {
                    ...
                    if (c === null || c === "")
                        this.id = c = "DataTables_Table_" + l.ext._oExternConfig.iNextUnique++;
                    var g = i.extend(true, {}, l.models.oSettings, {nTable: this, oApi: sa.oApi, oInit: h, sDestroyWidth: i(this).width(), sInstance: c, sTableId: c});
                    l.settings.push(g);
                    ...
                    if (g.oFeatures.bServerSide && g.oFeatures.bSort && g.oFeatures.bSortClasses)
                        J(g, "aoDrawCallback", ba, "server_side_sort_classes");
                    else
                        g.oFeatures.bDeferRender && J(g, "aoDrawCallback", ba, "defer_sort_classes");
                    if (h.bJQueryUI) {
                        i.extend(g.oClasses, l.ext.oJUIClasses);
                        if (h.sDom === l.defaults.sDom && l.defaults.sDom === "lfrtip")
                            g.sDom = '<"H"lfr>t<"F"ip>'
                    } else
                        i.extend(g.oClasses, l.ext.oStdClasses);
                    i(this).addClass(g.oClasses.sTable);
                    if (g.oScroll.sX !== "" || g.oScroll.sY !== "")
                        g.oScroll.iBarWidth = eb();
                    ...
                    if (h.oLanguage.sUrl !== "") {
                        ...
                        i.extend(true, g.oLanguage, h.oLanguage);
                    if (h.asStripeClasses === null)
                        g.asStripeClasses = [g.oClasses.sStripeOdd, g.oClasses.sStripeEven];
                    ...
                    if (b) {
                        ...
                        for (a = 0; a < b; a++)
                            if (d.hasClass(g.asStripeClasses[a])) {
                                c = true;
                    ...
                    for (b = g.aaSorting.length; a < b; a++) {
                        if (g.aaSorting[a][0] >= g.aoColumns.length)
                            g.aaSorting[a][0] =
                                    0;
                        var j = g.aoColumns[g.aaSorting[a][0]];
                        if (g.aaSorting[a][2] === p)
                            g.aaSorting[a][2] = 0;
                        if (h.aaSorting === p && g.saved_aaSorting === p)
                            g.aaSorting[a][1] = j.asSorting[0];
                        c = 0;
                        for (d = j.asSorting.length; c < d; c++)
                            if (g.aaSorting[a][1] == j.asSorting[c]) {
                                g.aaSorting[a][2] = c;
                                break
                            }
                    }
        ...
        l.fnIsDataTable = function (h) {
            for (var n = l.settings, q = 0; q < n.length; q++)
                if (n[q].nTable === h || n[q].nScrollHead === h || n[q].nScrollFoot === h)
                    return true;
            return false
        };
        l.fnTables = function (h) {
            ...
            jQuery.each(l.settings,
                    function (q, o) {
                        if (!h || h === true && i(o.nTable).is(":visible"))
                            n.push(o.nTable)
                    });
            return n
        };
        ...
        l.settings = [];
        l.models = {};
        l.models.ext = {afnFiltering: [], afnSortData: [], aoFeatures: [], aTypes: [], fnVersionCheck: l.fnVersionCheck, iApiIndex: 0, ofnSearch: {}, oApi: {}, oStdClasses: {}, oJUIClasses: {}, oPagination: {}, oSort: {}, sVersion: l.version, sErrMode: "alert", _oExternConfig: {iNextUnique: 0}};
        l.models.oSearch = {bCaseInsensitive: true, sSearch: "", bRegex: false, bSmart: true};
        l.models.oRow = {nTr: null, _aData: [], _aSortData: [],
            _anHidden: [], _sRowStripe: ""};
        l.models.oColumn = {aDataSort: null, asSorting: null, bSearchable: null, bSortable: null, bUseRendered: null, bVisible: null, _bAutoType: true, fnCreatedCell: null, fnGetData: null, fnRender: null, fnSetData: null, mData: null, mRender: null, nTh: null, nTf: null, sClass: null, sContentPadding: null, sDefaultContent: null, sName: null, sSortDataType: "std", sSortingClass: null, sSortingClassJUI: null, sTitle: null, sType: null, sWidth: null, sWidthOrig: null};
        l.defaults = {aaData: null, aaSorting: [[0, "asc"]], aaSortingFixed: null,
            aLengthMenu: [5,10, 25, 50, 100], aoColumns: null, aoColumnDefs: null, aoSearchCols: [], asStripeClasses: null, bAutoWidth: true, bDeferRender: false, bDestroy: false, bFilter: true, bInfo: true, bJQueryUI: false, bLengthChange: true, bPaginate: true, bProcessing: false, bRetrieve: false, bScrollAutoCss: true, bScrollCollapse: false, bScrollInfinite: false, bServerSide: false, bSort: true, bSortCellsTop: false, bSortClasses: true, bStateSave: false, fnCookieCallback: null, fnCreatedRow: null, fnDrawCallback: null, fnFooterCallback: null, fnFormatNumber: function (h) {
                if (h <
                        1E3)
                    return h;
                var n = h + "";
                ...
                for (var o = 0; o < n; o++) {
                    if (o % 3 === 0 && o !== 0)
                        q = this.oLanguage.sInfoThousands + q;
                    q = h[n - o - 1] + q
                }
                return q
            }, fnHeaderCallback: null, fnInfoCallback: null, fnInitComplete: null, fnPreDrawCallback: null, fnRowCallback: null, fnServerData: function (h, n, q, o) {
                o.jqXHR = i.ajax({url: h, data: n, success: function (v) {
            ...
            }, fnServerParams: null, fnStateLoad: function (h) {
                ...
                return n
            }, fnStateLoadParams: null, fnStateLoaded: null, fnStateSave: function (h, n) {
        ...
        l.defaults.columns = {aDataSort: null, asSorting: ["asc", "desc"], bSearchable: true, bSortable: true,
            bUseRendered: true, bVisible: true, fnCreatedCell: null, fnRender: null, iDataSort: -1, mData: null, mRender: null, sCellType: "td", sClass: "", sContentPadding: "", sDefaultContent: null, sName: "", sSortDataType: "std", sTitle: null, sType: null, sWidth: null};
        l.models.oSettings = {oFeatures: {bAutoWidth: null, bDeferRender: null, bFilter: null, bInfo: null, bLengthChange: null, bPaginate: null, bProcessing: null, bServerSide: null, bSort: null, bSortClasses: null, bStateSave: null}, oScroll: {bAutoCss: null, bCollapse: null, bInfinite: null, iBarWidth: 0, iLoadGap: null,
            ...
            _iDisplayStart: 0, _iDisplayEnd: 10, _iRecordsTotal: 0, _iRecordsDisplay: 0, bJUI: null, oClasses: {}, bFiltered: false, bSorted: false, bSortCellsTop: null, oInit: null, aoDestroyCallback: [], fnRecordsTotal: function () {
        ...
        i.extend(l.ext.oStdClasses, {sTable: "dataTable", sPagePrevEnabled: "paginate_enabled_previous", sPagePrevDisabled: "paginate_disabled_previous", sPageNextEnabled: "paginate_enabled_next", sPageNextDisabled: "paginate_disabled_next", sPageJUINext: "",
        ...
        i.extend(l.ext.oPagination, {two_button: {fnInit: function (h, n, q) {
                    ...
                    if (h.aanFeatures.p)
                        for (var n = h.oClasses, q = h.aanFeatures.p, o, v = 0, w = q.length; v < w; v++)
                            if (o = q[v].firstChild) {
            ...
            full_numbers: {fnInit: function (h, n, q) {
                    ...
                    if (h.aanFeatures.p) {
                        var q = l.ext.oPagination.iFullNumbersShowPages, o = Math.floor(q / 2), v =
                                Math.ceil(h.fnRecordsDisplay() / h._iDisplayLength), w = Math.ceil(h._iDisplayStart / h._iDisplayLength) + 1, D = "", A, G = h.oClasses, E, Y = h.aanFeatures.p, ma = function (R) {
                        ...
                        for (q = A; q <= o; q++)
                            D += w !== q ? '<a tabindex="' + h.iTabIndex + '" class="' + G.sPageButton + '">' + h.fnFormatNumber(q) +
        ...
        i.extend(l.ext.oSort, {"string-pre": function (h) {
                if (typeof h != "string")
                    h = h !== null && h.toString ? h.toString() : "";
                ...
                h = Date.parse(h);
                if (isNaN(h) || h === "")
                    h = Date.parse("01/01/1970 00:00:00");
                return h
        ...
        i.extend(l.ext.aTypes, [function (h) {
                ...
                var n = Date.parse(h);
                if (n !== null && !isNaN(n) || typeof h === "string" && h.length === 0)
                    return"date";
                return null
            }, function (h) {
                if (typeof h === "string" && h.indexOf("<") != -1 && h.indexOf(">") != -1)
                    return"html";
                return null
            }]);
        i.fn.DataTable = l;
