                            ...
                            <div class="page-nav-options">
                                <div class="span9">
                                    <ul class="nav nav-tabs pull-right" style="float: right!important;">
                                        <li class="active">
                                            <a href="<?php echo base_url('site/add') ?>"><i class="icon-plus"></i>Add</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="span16">
                            <div id="Person-1" class="box">
                                ...
                                <div class="box-content box-table">
                                    <table class="table table-hover tablesorter" id="antenna-table" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th>Site ID</th>
                                                <th>Sector</th>
                                                <th>Pole</th>
                                                <th>Collo</th>
                                                <th>Antena Radius Center</th>
                                                <th>Above Ground Distance</th>
                                                <th>Min Controlled Distance</th>
                                                <th>Min Uncontrolled Distance</th>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                var oTable = $('#antenna-table').dataTable({
                    "bProcessing": true,
                    "bServerSide": true,
                    "sAjaxSource": '<?php echo base_url(); ?>site/get_data',
