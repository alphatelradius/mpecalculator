                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Antenna<small>Upload Data</small></h2>
                                ...
                                <div class="x_content">
                                    <br/>
                                    <form action="<?php echo base_url('antenna/do_upload') ?>" class="dropzone" style="border: 1px solid #e5e5e5; height: 300px; ">
                                    </form>
                                    <a style="margin-top: 20px;" class="pull-right" href="<?php echo base_url('antenna/save') ?>"><div class="btn btn-primary">Process</div></a>
                                </div>
                            </div 
                        </div>
                    </div>
